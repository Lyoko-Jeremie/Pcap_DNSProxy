...
:: 检查bin程序组完整性
..\Binary\md5 -c609F46A341FEDEAEEC18ABF9FB7C9647 ..\Binary\md5.exe 2>nul||echo.依赖程序似乎被破坏了, 重新安装一次试试?&&ping -n 5 127.0.0.1>nul&&goto END
..\Binary\md5 -cC7D538B88A4A306B462BE0835025BCEF ..\Binary\curl.exe 2>nul||echo.依赖程序似乎被破坏了, 重新安装一次试试?&&ping -n 5 127.0.0.1>nul&&goto END
..\Binary\md5 -cC95C0A045697BE8F782C71BD46958D73 ..\Binary\sed.exe 2>nul||echo.依赖程序似乎被破坏了, 重新安装一次试试?&&ping -n 5 127.0.0.1>nul&&goto END
..\Binary\md5 -c9A5E35DCB4B35A2350E6FDF4620743B6 ..\Binary\CCase.exe 2>nul||echo.依赖程序似乎被破坏了, 重新安装一次试试?&&ping -n 5 127.0.0.1>nul&&goto END
