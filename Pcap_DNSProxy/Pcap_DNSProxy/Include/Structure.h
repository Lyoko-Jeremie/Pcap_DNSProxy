...
*/
#define IPV6_HEADER_FRAGMENT_GET_BIT_MF            0x0001   //Get More Fragment bit in Fragment Header.
#define IPV6_HEADER_FRAGMENT_GET_FRAGMENT_OFFSET   0xFFF8   //Get Fragment Offset bits in Fragment Header.
...
/* Internet Control Message Protocol version 6/ICMPv6, Transmission Control Protocol/TCP and User Datagram Protocol/UDP Pseudo header with IPv6
...
//////////////////////////////////////////////////
// Domain Name System protocol structure
// 
...
#endif
#ifndef IPPORT_LLMNR
	#define IPPORT_LLMNR                 IPPORT_MDNS                          //Link-Local Multicast Name Resolution/LLMNR Port
#endif
...
#define DNS_FLAG_GET_MOVE_BIT_OPCODE     11U                              //Move OPCode to the right.
...
#endif
#ifndef DNS_OPCODE_DSO
	#define DNS_OPCODE_DSO             6U               //OPCode DSO/DNS Stateful Operations is 6.
#endif
...
//Classes definition
	...
	#define DNS_CLASS_ALL           0x00FF           //DNS QCLASS NONE Classes is 255.
#endif
#ifndef DNS_CLASS_ANY
	#define DNS_CLASS_ANY           0x00FF           //DNS QCLASS * (ANY) Classes is 255.
#endif
...
#endif
#ifndef DNS_RCODE_DSOTYPENI
	#define DNS_RCODE_DSOTYPENI     0x000B           //RCode DSO-TYPE Not Implemented is 11.
#endif
...
//DNS CSYNC/Child Synchronization flags definition
#ifndef DNS_CSYNC_IMMEDIATE
	#define DNS_CSYNC_IMMEDIATE   0x0001             //DNS CSYNC immediate flags is 1.
#endif
#ifndef DNS_CSYNC_SOAMINIMUM
	#define DNS_CSYNC_SOAMINIMUM  0x0002             //DNS CSYNC soaminimum flags is 1.
#endif

//DNS Stateful Operations definition
#ifndef DNS_DSO_RESERVED
	#define DNS_DSO_RESERVED            0            //DNS DSO reserved is 0.
#endif
#ifndef DNS_DSO_KEEPALIVE
	#define DNS_DSO_KEEPALIVE           0x0001       //DNS DSO keep alive is 1.
#endif
#ifndef DNS_DSO_RETRYDELAY
	#define DNS_DSO_RETRYDELAY          0x0002       //DNS DSO retry delay is 2.
#endif
#ifndef DNS_DSO_ENCRYPTIONPADDING
	#define DNS_DSO_ENCRYPTIONPADDING   0x0003       //DNS DSO encryption padding is 3.
#endif
#ifndef DNS_DSO_PRIVATE_A
	#define DNS_DSO_PRIVATE_A           0xF800       //DNS Reserved Private use DSO is begin at 63488.
#endif
#ifndef DNS_DSO_PRIVATE_B
	#define DNS_DSO_PRIVATE_B           0xFBFF       //DNS Reserved Private use DSO is end at 64511.
#endif
...
*/
#define DNS_FLAG_RCODE_TRADITIONAL_SIZE       4U                                                                    //Size of traditional RCode, in bits
...
/* Domain Name System/DNS Name Server/NS Records
...
*/
typedef struct _dns_record_ns_
{
	uint8_t               *NSDName;
}dns_record_ns;
...
/* Domain Name System/DNS MB Records
...
*/
typedef struct _dns_record_mb_
{
	uint8_t               *MADName;
}dns_record_mb;

/* Domain Name System/DNS MG Records
...
*/
typedef struct _dns_record_mg_
{
	uint8_t               *MGMName;
}dns_record_mg;

/* Domain Name System/DNS MR Records
...
*/
typedef struct _dns_record_mr_
{
	uint8_t               *NEWName;
}dns_record_mr;
...
/* Domain Name System/DNS MINFO Records
...
*/
typedef struct _dns_record_minfo_
{
	uint8_t               *RMAILBX;
	uint8_t               *EMAILBX;
}dns_record_minfo;
...
#define EDNS_CODE_RESERVED         0             //Reserved(RFC 6891)
...
#define EDNS_CODE_CLIENT_TAG       0x0010        //EDNS-Client-Tag
#define EDNS_CODE_SERVER_TAG       0x0011        //EDNS-Server-Tag
#define EDNS_CODE_DEVICEID         0x6942        //Device ID
...
/* No need to define sub structure.
	union {
		uint64_t          ServerCookieMin;
		uint64_t[4U]      ServerCookieMax;
	}ServerCookie;
*/
}edns_cookies;
...
//IANA Delegation Signer (DS) Resource Record (RR) Type Digest Algorithms(https://www.iana.org/assignments/ds-rr-types/ds-rr-types.xhtml)
...
*/
//IANA Domain Name System Security (DNSSEC) NextSECure3 (NSEC3) Parameters(https://www.iana.org/assignments/dnssec-nsec3-parameters/dnssec-nsec3-parameters.xhtml)
...
typedef struct _dnscrypt_txt_signature_
{
	...
	uint32_t              Serial;
	uint32_t              CertTimeBegin;
	uint32_t              CertTimeEnd;
...
*/
//SOCKS Version 4, Method, Command and Reply definition
...
//SOCKS Version 5, Method, Command and Reply definition
