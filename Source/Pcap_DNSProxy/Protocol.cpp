...
//Initialization
	std::string AddrString((const char *)AddrBuffer);
	...
	const void * const OriginalAddrEnd)
{
	if (Protocol == AF_INET6)
	{
		...
		{
			if (((in6_addr *)OriginalAddrBegin)->s6_addr[Index] > ((in6_addr *)OriginalAddrEnd)->s6_addr[Index])
			{
				return ADDRESS_COMPARE_TYPE::GREATER;
			}
			else if (((in6_addr *)OriginalAddrBegin)->s6_addr[Index] == ((in6_addr *)OriginalAddrEnd)->s6_addr[Index])
			{
	...
	{
		if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr) > *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr))
		{
			return ADDRESS_COMPARE_TYPE::GREATER;
		}
		else if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr) == *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr))
		{
			if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t)) > *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t)))
			{
				return ADDRESS_COMPARE_TYPE::GREATER;
			}
			else if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t)) == *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t)))
			{
				if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t) * 2U) > *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t) * 2U))
				{
					return ADDRESS_COMPARE_TYPE::GREATER;
				}
				else if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t) * 2U) == *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t) * 2U))
				{
					if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t) * 3U) > *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t) * 3U))
						return ADDRESS_COMPARE_TYPE::GREATER;
					else if (*((uint8_t *)&((in_addr *)OriginalAddrBegin)->s_addr + sizeof(uint8_t) * 3U) == *((uint8_t *)&((in_addr *)OriginalAddrEnd)->s_addr + sizeof(uint8_t) * 3U))
						return ADDRESS_COMPARE_TYPE::EQUAL;
					else 
						return ADDRESS_COMPARE_TYPE::LESS;
				}
...
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0x90 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0) || //::90xx:xxxx:0:0, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x10 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0x22 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x22) || //10::2222, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x21 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x02) || //21:2::2, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0x12 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 34) || //101::1234, including in reserved address ranges
		//New DNS Poisoning addresses which had been added in August 2016
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x02 && 
			((((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x08 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x07 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0xC6 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x2D) || //200:2:807:C62D::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x25 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x3D && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x36 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x9E) || //200:2:253D:369E::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x2E && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x52 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0xAE && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x44) || //200:2:2E52:AE44::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x3B && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x18 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x03 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0xAD) || //200:2:3B18:3AD::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x4E && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x10 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x31 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x0F) || //200:2:4E10:310F::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x5D && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x2E && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x08 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x59) || //200:2:5D2E:859::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x9F && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x6A && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x79 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x4B) || //200:2:9F6A:794B::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0xCB && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x62 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0x07 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x41) || //200:2:CB62:741::, including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[4U] == 0xF3 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0xB9 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0xBB && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x27)) && //200:2:F3B9:BB27::, including in reserved address ranges
			((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[15U] == 0) || 
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && 
			((IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[14U] == 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x12) || //2001::212
			(((in6_addr *)OriginalAddr)->s6_addr[2U] == 0x0D && ((in6_addr *)OriginalAddr)->s6_addr[3U] == 0xA8 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x01 && 
			((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x12 && ((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[14U] == 0x21 && ((in6_addr *)OriginalAddr)->s6_addr[15U] == 0xAE))) || //2001:DA8:112::21AE
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x03 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0xFF && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x01 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0x03 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0x04 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0x5F && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0xFF) || //2003:FF:1:2:3:4:5FFF:xxxx
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x21 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x23 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0x3E && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x12) || //2123::3E12
		...
		//Also https://www.iana.org/assignments/ipv6-address-space/ipv6-address-space.xhtml and https://www.iana.org/assignments/iana-ipv6-special-registry/iana-ipv6-special-registry.xhtml
			((in6_addr *)OriginalAddr)->s6_addr[0] == 0 || //Reserved by IETF(::/8)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0) || //IPv4-Compatible Contrast addresses(::/96, Section 2.5.5.1 in RFC 4291), including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0) || //Unspecified addresses(::, Section 2.5.2 in RFC 4291), including in reserved address ranges
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x01) || //Loopback addresses(::1, Section 2.5.3 in RFC 4291)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0xFF && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0xFF) || //IPv4-mapped addresses(::FFFF:xxxx:xxxx/96, Section 2.5.5 in RFC 4291), including in reserved address ranges
			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x64 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0xFF && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x9B && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0) || //Well Known Prefix addresses(64:FF9B::xxxx:xxxx/96, Section 2.1 in RFC 4773), including in reserved address ranges
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x01) || //Reserved by IETF(0100::/8)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0) || //Discard Prefix addresses(100::/64, Section 4 RFC 6666), including in reserved address ranges
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x03) || //Reserved by IETF(0200::/7), deprecated as of RFC 4048 and formerly an OSI NSAP-mapped prefix set in RFC 4548
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x04 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x07) || //Reserved by IETF(0400::/6)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x08 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x15) || //Reserved by IETF(0800::/5)
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x10) || //Reserved by IETF(1000::/4)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] <= 0x01) || //IETF Protocol Assignments(2001::/23, RFC 2928)
/*
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0) || //Teredo relay/tunnel addresses(2001::/32, RFC 4380), including in reserved address ranges
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] <= 0x07) || //Sub-TLA IDs assigned to IANA addresses(2001::/29, Section 2 in RFC 4773)
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[8U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[9U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[10U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[11U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[12U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[13U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[14U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[15U] == 0x01) || //Port Control Protocol Anycast(2001:1::1/128, RFC 7723)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x02 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0) || //Benchmarking(2001:2::/48, RFC 5180)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x03) || //AMT(2001:3::/32, RFC 7450)
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x04 && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0x12) || //AS112-v6(2001:4:112::/48, RFC 7535)
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x05) || //EID Space for LISP, Managed by RIPE NCC(2001:5::/32, RFC-ietf-lisp-eid-block-13)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] >= 0x10 && ((in6_addr *)OriginalAddr)->s6_addr[3U] <= 0x1F) || //Deprecated, previously ORCHID(2001:10::/28, RFC 4843)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] >= 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[3U] <= 0x2F) || //ORCHIDv2(2001:20::/28, RFC 7343)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0x01 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] >= 0xF8) || //Sub-TLA IDs assigned to IANA addresses(2001:01F8::/29, Section 2 in RFC 4773)
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x01 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0x0D && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0xB8) || //Contrast Address prefix reserved for documentation addresses(2001:DB8::/32, RFC 3849)
			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x02) || //6to4 relay/tunnel addresses(2002::/16, Section 2 in RFC 3056)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x26 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0x20 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0x4F && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0x80 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0) || //Direct Delegation AS112 Service(2620:4F:8000::/48, RFC 7534)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x3F && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0xFE) || //6bone(3FFE::/16, RFC 3701)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x40 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x5F) || //Reserved by IETF(4000::/3)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0x5F) || //6bone(5F00::/8, RFC 3701)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x60 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x7F) || //Reserved by IETF(6000::/3)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0x80 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0x9F) || //Reserved by IETF(8000::/3)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xA0 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xBF) || //Reserved by IETF(A000::/3)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xC0 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xDF) || //Reserved by IETF(C000::/3)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xE0 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xEF) || //Reserved by IETF(E000::/4)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xF0 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xF7) || //Reserved by IETF(F000::/5)
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xF8 && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xFB) || //Reserved by IETF(F800::/6)
*/
			(((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xFC && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xFD) || //Unique Local Unicast addresses/ULA(FC00::/7, Section 2.5.7 in RFC 4193)
/*			(((in6_addr *)OriginalAddr)->s6_addr[0] == 0xFE && ((in6_addr *)OriginalAddr)->s6_addr[1U] <= 0x7F) || //Reserved by IETF(FE00::/9)
*/			
			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0xFE && ((in6_addr *)OriginalAddr)->s6_addr[1U] >= 0x80 && ((in6_addr *)OriginalAddr)->s6_addr[1U] <= 0xBF) || //Link-Local Unicast Contrast addresses/LUC(FE80::/10, Section 2.5.6 in RFC 4291)
/*			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[1U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[2U] == 0x5E && 
			((in6_addr *)OriginalAddr)->s6_addr[3U] == 0xFE && ((in6_addr *)OriginalAddr)->s6_addr[4U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[5U] == 0 && 
			((in6_addr *)OriginalAddr)->s6_addr[6U] == 0 && ((in6_addr *)OriginalAddr)->s6_addr[7U] == 0) || //ISATAP Interface Identifiers addresses(0:5EFE:0:0:0:0/64, which also in Link-Local Unicast Contrast addresses/LUC, Section 6.1 in RFC 5214)
*/
			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0xFE && ((in6_addr *)OriginalAddr)->s6_addr[1U] >= 0xC0) || //Site-Local scoped addresses(FEC0::/10, RFC 3879)
			(IsPrivateUse && ((in6_addr *)OriginalAddr)->s6_addr[0] == 0xFF)) //Multicast addresses(FF00::/8, Section 2.7 in RFC 4291)
				return true;
	...
	//Result Blacklist check
		...
		//Domain Case Conversion
			std::string DomainString((const char *)DomainBuffer);
						...
						(ResultBlacklistTableIter.PatternString.empty() || std::regex_match(DomainString, ResultBlacklistTableIter.PatternRegex)))
					{
						for (const auto &AddressRangeTableIter:ResultBlacklistTableIter.Addresses)
						{
							if ((AddressRangeTableIter.End.ss_family == AF_INET6 && 
								AddressesComparing(AF_INET6, OriginalAddr, &((PSOCKADDR_IN6)&AddressRangeTableIter.Begin)->sin6_addr) >= ADDRESS_COMPARE_TYPE::EQUAL && 
								AddressesComparing(AF_INET6, OriginalAddr, &((PSOCKADDR_IN6)&AddressRangeTableIter.End)->sin6_addr) <= ADDRESS_COMPARE_TYPE::EQUAL) || 
								memcmp(OriginalAddr, &((PSOCKADDR_IN6)&AddressRangeTableIter.Begin)->sin6_addr, sizeof(in6_addr)) == 0)
									return true;
						}
					}
				}
							...
							memcmp(OriginalAddr, &((PSOCKADDR_IN6)&AddressRangeTableIter.Begin)->sin6_addr, sizeof(in6_addr)) == 0)
						{
							...
							//Rewrite address.
								if (AddressHostsTableIter.Address_Target.front().second > 0)
								{
									...
									{
										*((uint64_t *)OriginalAddr) = hton64(ntoh64(*((uint64_t *)OriginalAddr)) & (UINT64_MAX >> AddressHostsTableIter.Address_Target.front().second));
										*((uint64_t *)OriginalAddr) = hton64(ntoh64(*((uint64_t *)OriginalAddr)) | ntoh64(*((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin6_addr)));
									}
									else {
										*((uint64_t *)OriginalAddr) = *((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin6_addr);
										*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U)) = hton64(ntoh64(*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U))) & (UINT64_MAX >> (AddressHostsTableIter.Address_Target.front().second - sizeof(in6_addr) * BYTES_TO_BITS / 2U)));
										*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U)) = hton64(ntoh64(*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U))) | ntoh64(*((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin6_addr)));
									}
								}
								else {
									*(in6_addr *)OriginalAddr = ((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin6_addr;
								}
							}
							else {
							//Rewrite address.
								if (AddressHostsTableIter.Address_Target.front().second > 0)
								{
									...
									{
										*((uint64_t *)OriginalAddr) = hton64(ntoh64(*((uint64_t *)OriginalAddr)) & (UINT64_MAX >> AddressHostsTableIter.Address_Target.front().second));
										*((uint64_t *)OriginalAddr) = hton64(ntoh64(*((uint64_t *)OriginalAddr)) | ntoh64(*((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.front().first)->sin6_addr)));
									}
									else {
										*((uint64_t *)OriginalAddr) = *((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.front().first)->sin6_addr);
										*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U)) = hton64(ntoh64(*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U))) & (UINT64_MAX >> (AddressHostsTableIter.Address_Target.front().second - sizeof(in6_addr) * BYTES_TO_BITS / 2U)));
										*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U)) = hton64(ntoh64(*((uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U))) | ntoh64(*((uint64_t *)&((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.front().first)->sin6_addr)));
									}
								}
								else {
									*(in6_addr *)OriginalAddr = ((PSOCKADDR_IN6)&AddressHostsTableIter.Address_Target.front().first)->sin6_addr;
								}
							}
	...
	else if (Protocol == AF_INET)
	{
		if (
		//DNS Poisoning addresses from CERNET2, visit https://code.google.com/p/goagent/issues/detail?id=17571.
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x01020304 || //1.2.3.4
		//Traditional DNS Poisoning addresses, visit https://zh.wikipedia.org/wiki/%E5%9F%9F%E5%90%8D%E6%9C%8D%E5%8A%A1%E5%99%A8%E7%BC%93%E5%AD%98%E6%B1%A1%E6%9F%93#.E8.99.9A.E5.81.87IP.E5.9C.B0.E5.9D.80.
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x042442B2 || //4.36.66.178
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x0807C62D || //8.7.198.45
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x253D369E || //37.61.54.158
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x2E52AE44 || //46.82.174.68
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x3B1803AD || //59.24.3.173
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x402158A1 || //64.33.88.161
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4021632F || //64.33.99.47
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4042A3FB || //64.66.163.251
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4168CAFC || //65.104.202.252
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x41A0DB71 || //65.160.219.113
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x422DFCED || //66.45.252.237
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x480ECD63 || //72.14.205.99
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x480ECD68 || //72.14.205.104
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4E10310F || //78.16.49.15
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x5D2E0859 || //93.46.8.89
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x80797E8B || //128.121.126.139
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x9F1803AD || //159.24.3.173
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x9F6A794B || //159.106.121.75
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xA9840D67 || //169.132.13.103
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xC043C606 || //192.67.198.6
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCA6A0102 || //202.106.1.2
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCAB50755 || //202.181.7.85
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCB620741 || //203.98.7.65
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCBA1E6AB || //203.161.230.171
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCF0C5862 || //207.12.88.98
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD0381F2B || //208.56.31.43
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD1244921 || //209.36.73.33
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD1913632 || //209.145.54.50
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD1DC1EAE || //209.220.30.174
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD35E4293 || //211.94.66.147
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD5A9FB23 || //213.169.251.35
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD8DDBCD6 || //216.221.188.182
		//New DNS Poisoning addresses which had been added in May 2011, visit http://forums.internetfreedom.org/index.php?topic=7953.0.
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x1759053C || //23.89.5.60
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x31027B38 || //49.2.123.56
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x364C8701 || //54.76.135.1
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4D04075C || //77.4.7.92
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x76050460 || //118.5.4.96
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xBC050460 || //188.5.4.96
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xBDA31105 || //189.163.17.5
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xC504040C || //197.4.4.12
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD8EAB30D || //216.234.179.13
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xF3B9BB27 || //243.185.187.39, including in reserved address ranges
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xF9812E30 || //249.129.46.48, including in reserved address ranges
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xFD9D0EA5 || //253.157.14.165, including in reserved address ranges
		//China Network Anomaly in 2014-01-21, visit https ://zh.wikipedia.org/wiki/2014%E5%B9%B4%E4%B8%AD%E5%9B%BD%E7%BD%91%E7%BB%9C%E5%BC%82%E5%B8%B8%E4%BA%8B%E4%BB%B6
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x413102B2 || //65.49.2.178
		//New addresses in IPv6 which has been added in September 2014, visit https://code.google.com/p/goagent/issues/detail?id=17571.
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x01010101 || //1.1.1.1
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x0A0A0A0A || //10.10.10.10
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x14141414 || //20.20.20.20
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xFFFFFFFF || //255.255.255.255, including in reserved address ranges
...
//			Addr.s_addr == 0 || //0.0.0.0, including in reserved address ranges
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x02010102 || //2.1.1.2
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x04C15000 || //4.193.80.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x08695400 || //8.105.84.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x0C578500 || //12.87.133.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x103F9B00 || //16.63.155.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x148B3800 || //20.139.56.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x1833B800 || //24.51.184.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x1C797E8B || //28.121.126.139
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x1C0DD800 || //28.13.216.0
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x2E147EFC || //46.20.126.252
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x2E2618D1 || //46.38.24.209
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x3D361C06 || //61.54.28.6
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x42CE0BC2 || //66.206.11.194
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x4A75398A || //74.117.57.138
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x591F376A || //89.31.55.106
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x710BC2BE || //113.11.194.190
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x76053106 || //118.5.49.6
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x7ADA65BE || //122.218.101.190
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x7B3231AB || //123.50.49.171
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x7B7EF9EE || //123.126.249.238
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x7DE69430 || //125.230.148.48
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0x7F000002 || //127.0.0.2, including in reserved address ranges
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xADC9D806 || //173.201.216.6
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xCBC73951 || //203.199.57.81
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD06D8A37 || //208.109.138.55
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD3058512 || //211.5.133.18
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD308451B || //211.8.69.27
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD5BA2105 || //213.186.33.5
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xD88BD590 || //216.139.213.144
			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xDD08451B || //221.8.69.27
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xF3B9BB03 || //243.185.187.3, including in reserved address ranges
//			ntohl(((in_addr *)OriginalAddr)->s_addr) == 0xF3B9BB1E || //243.185.187.30, including in reserved address ranges
		...
		//Also https://www.iana.org/assignments/ipv4-address-space/ipv4-address-space.xhtml
			*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0 || //Current network whick only valid as source addresses(0.0.0.0/8, Section 3.2.1.3 in RFC 1122)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0x0A) || //Private class A addresses(10.0.0.0/8, Section 3 in RFC 1918)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0x7F && //Loopback address(127.0.0.0/8, Section 3.2.1.3 in RFC 1122)
			!(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 3U) == 0x01)) || //The first of Loopback block address(127.0.0.1)
			( /* IsPrivateUse && */ *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0x64 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) > 0x40 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) < 0x7F) || //Carrier-grade NAT addresses(100.64.0.0/10, Section 7 in RFC 6598)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xA9 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) >= 0xFE) || //Link-local addresses(169.254.0.0/16, Section 1.5 in RFC 3927)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xAC && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) >= 0x10 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) <= 0x1F) || //Private class B addresses(172.16.0.0/12, Section 3 in RFC 1918)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 3U) < 0x08) || //DS-Lite transition mechanism addresses(192.0.0.0/29, Section 3 in RFC 6333)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0) || //Reserved for IETF protocol assignments addresses(192.0.0.0/24, Section 3 in RFC 5735)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0x02) || //TEST-NET-1 addresses(192.0.2.0/24, Section 3 in RFC 5735)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0x58 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0x63) || //6to4 relay/tunnel addresses(192.88.99.0/24, Section 2.3 in RFC 3068)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0xA8) || //Private class C addresses(192.168.0.0/16, Section 3 in RFC 1918)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC6 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0x12) || //Benchmarking Methodology for Network Interconnect Devices addresses(198.18.0.0/15, Section 11.4.1 in RFC 2544)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC6 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0x33 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0x64) || //TEST-NET-2 addresses(198.51.100.0/24, Section 3 in RFC 5737)
			(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xCB && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == 0x71) || //TEST-NET-3 addresses(203.0.113.0/24, Section 3 in RFC 5737)
			(IsPrivateUse && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xE0) || //Multicast addresses(224.0.0.0/4, Section 2 in RFC 3171)
			*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) >= 0xF0) //Reserved for future use address(240.0.0.0/4, Section 4 in RFC 1112) and Broadcast addresses(255.255.255.255/32, Section 7 in RFC 919/RFC 922)
				return true;
						...
						(ResultBlacklistTableIter.PatternString.empty() || std::regex_match(DomainString, ResultBlacklistTableIter.PatternRegex)))
					{
						for (const auto &AddressRangeTableIter:ResultBlacklistTableIter.Addresses)
						{
							if ((AddressRangeTableIter.End.ss_family == AF_INET && 
								AddressesComparing(AF_INET, OriginalAddr, &((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr) >= ADDRESS_COMPARE_TYPE::EQUAL && 
								AddressesComparing(AF_INET, OriginalAddr, &((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr) <= ADDRESS_COMPARE_TYPE::EQUAL) || 
								((in_addr *)OriginalAddr)->s_addr == ((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr)
									return true;
						}
					}
				}
					...
					//Check address.
							...
							((in_addr *)OriginalAddr)->s_addr == ((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr)
						{
							...
							//Rewrite address.
								if (AddressHostsTableIter.Address_Target.front().second > 0)
								{
									((in_addr *)OriginalAddr)->s_addr = htonl(ntohl(((in_addr *)OriginalAddr)->s_addr) & (UINT32_MAX >> AddressHostsTableIter.Address_Target.front().second));
									((in_addr *)OriginalAddr)->s_addr = htonl(ntohl(((in_addr *)OriginalAddr)->s_addr) | ntohl(((PSOCKADDR_IN)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin_addr.s_addr));
								}
								else {
									*(in_addr *)OriginalAddr = ((PSOCKADDR_IN)&AddressHostsTableIter.Address_Target.at(RamdomDistribution(*GlobalRunningStatus.RamdomEngine)).first)->sin_addr;
								}
							}
							else {
							//Rewrite address.
								...
								{
									((in_addr *)OriginalAddr)->s_addr = htonl(ntohl(((in_addr *)OriginalAddr)->s_addr) & (UINT32_MAX >> AddressHostsTableIter.Address_Target.front().second));
									((in_addr *)OriginalAddr)->s_addr = htonl(ntohl(((in_addr *)OriginalAddr)->s_addr) | ntohl(((PSOCKADDR_IN)&AddressHostsTableIter.Address_Target.front().first)->sin_addr.s_addr));
								}
								else {
									*(in_addr *)OriginalAddr = ((PSOCKADDR_IN)&AddressHostsTableIter.Address_Target.front().first)->sin_addr;
								}
							}
...
//Check address routing.
		...
		for (const auto &IPFilterFileSetIter:*IPFilterFileSetUsing)
		{
			for (const auto &LocalRoutingTableIter:IPFilterFileSetIter.LocalRoutingList)
			{
				if (!LocalRoutingTableIter.AddressRoutingList_IPv6.empty())
				{
					...
					{
						if (LocalRoutingTableIter.AddressRoutingList_IPv6.count(ntoh64(*(uint64_t *)OriginalAddr) & (UINT64_MAX << (sizeof(in6_addr) * BYTES_TO_BITS / 2U - LocalRoutingTableIter.Prefix))) > 0)
							return true;
					}
					else {
						const auto AddrMapIter = LocalRoutingTableIter.AddressRoutingList_IPv6.find(ntoh64(*(uint64_t *)OriginalAddr));
						if (AddrMapIter != LocalRoutingTableIter.AddressRoutingList_IPv6.end() && 
							AddrMapIter->second.count(ntoh64(*(uint64_t *)((uint8_t *)OriginalAddr + sizeof(in6_addr) / 2U)) & (UINT64_MAX << (sizeof(in6_addr) * BYTES_TO_BITS - LocalRoutingTableIter.Prefix))) > 0)
								return true;
					}
				}
			}
	...
	else if (Protocol == AF_INET)
	{
		for (const auto &IPFilterFileSetIter:*IPFilterFileSetUsing)
		{
			for (const auto &LocalRoutingTableIter:IPFilterFileSetIter.LocalRoutingList)
			{
				if (LocalRoutingTableIter.AddressRoutingList_IPv4.count(ntohl(((in_addr *)OriginalAddr)->s_addr) & (UINT32_MAX << (sizeof(in_addr) * BYTES_TO_BITS - LocalRoutingTableIter.Prefix))) > 0)
					return true;
			}
		}
	}
...
//Proxy Mode address filter
	else if (Parameter.OperationMode == LISTEN_MODE::PROXY)
	{
		if ((Protocol == AF_INET6 && memcmp(OriginalAddr, &in6addr_loopback, sizeof(in6_addr)) == 0) || //Loopback address(::1, Section 2.5.3 in RFC 4291
			(Protocol == AF_INET && ((in_addr *)OriginalAddr)->s_addr == htonl(INADDR_LOOPBACK))) //Loopback address(127.0.0.0/8, Section 3.2.1.3 in RFC 1122)
				return true;
	}
//Private Mode address filter
	else if (Parameter.OperationMode == LISTEN_MODE::PRIVATE)
	{
	//IPv6
		if (Protocol == AF_INET6)
		{
			if ((((in6_addr *)OriginalAddr)->s6_addr[0] >= 0xFC && ((in6_addr *)OriginalAddr)->s6_addr[0] <= 0xFD) || //Unique Local Unicast address/ULA(FC00::/7, Section 2.5.7 in RFC 4193)
				(((in6_addr *)OriginalAddr)->s6_addr[0] == 0xFE && ((in6_addr *)OriginalAddr)->s6_addr[1U] >= 0x80 && ((in6_addr *)OriginalAddr)->s6_addr[1U] <= 0xBF) || //Link-Local Unicast Contrast address(FE80::/10, Section 2.5.6 in RFC 4291)
	...
	//IPv4
		...
		{
			if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0x0A || //Private class A address(10.0.0.0/8, Section 3 in RFC 1918)
				*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0x7F || //Loopback address(127.0.0.0/8, Section 3.2.1.3 in RFC 1122)
				(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xA9 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) >= 0xFE) || //Link-local addresses(169.254.0.0/16, Section 1.5 in RFC 3927)
				(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xAC && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) >= 0x10 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) <= 0x1F) || //Private class B address(172.16.0.0/12, Section 3 in RFC 1918)
				(*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == 0xC0 && *((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == 0xA8)) //Private class C address(192.168.0.0/16, Section 3 in RFC 1918)
					return true;
		}
	}
//Server Mode address filter
	else if (Parameter.OperationMode == LISTEN_MODE::SERVER)
	{
		return true;
	}
//Custom Mode address filter
	else if (Parameter.OperationMode == LISTEN_MODE::CUSTOM)
	{
		std::lock_guard<std::mutex> IPFilterFileMutex(IPFilterFileLock);
		if (Protocol == AF_INET6)
		{
			...
			if (Parameter.IsIPFilterTypePermit)
			{
				for (const auto &IPFilterFileSetIter:*IPFilterFileSetUsing)
				{
					...
					//Check address.
						for (size_t Index = 0;Index < sizeof(in6_addr) / sizeof(uint8_t);++Index)
						{
							if (((in6_addr *)OriginalAddr)->s6_addr[Index] > ((PSOCKADDR_IN6)&AddressRangeTableIter.Begin)->sin6_addr.s6_addr[Index] && 
								((in6_addr *)OriginalAddr)->s6_addr[Index] < ((PSOCKADDR_IN6)&AddressRangeTableIter.End)->sin6_addr.s6_addr[Index])
							{
								return true;
							}
							else if (((in6_addr *)OriginalAddr)->s6_addr[Index] == ((PSOCKADDR_IN6)&AddressRangeTableIter.Begin)->sin6_addr.s6_addr[Index] || 
								((in6_addr *)OriginalAddr)->s6_addr[Index] == ((PSOCKADDR_IN6)&AddressRangeTableIter.End)->sin6_addr.s6_addr[Index])
							{
								if (Index == sizeof(in6_addr) / sizeof(uint8_t) - 1U)
									return true;
		...
		//Permit mode
			if (Parameter.IsIPFilterTypePermit)
			{
				for (const auto &IPFilterFileSetIter:*IPFilterFileSetUsing)
				{
					...
					//Check address.
						if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) > *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr) && 
							*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) < *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr))
						{
							return true;
						}
						else if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr) || 
							*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr))
						{
							if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) > *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr + sizeof(uint8_t)) && 
								*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) < *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr + sizeof(uint8_t)))
							{
								return true;
							}
							else if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr + sizeof(uint8_t)) || 
								*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t)) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr + sizeof(uint8_t)))
							{
								if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) > *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr + sizeof(uint8_t) * 2U) && 
									*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) < *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr + sizeof(uint8_t) * 2U))
								{
									return true;
								}
								else if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr + sizeof(uint8_t) * 2U) || 
									*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 2U) == *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr + sizeof(uint8_t) * 2U))
								{
									if (*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 3U) >= *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.Begin)->sin_addr.s_addr + sizeof(uint8_t) * 3U) && 
										*((uint8_t *)&((in_addr *)OriginalAddr)->s_addr + sizeof(uint8_t) * 3U) <= *((uint8_t *)&((PSOCKADDR_IN)&AddressRangeTableIter.End)->sin_addr.s_addr + sizeof(uint8_t) * 3U))
											return true;
								}
							}
						}
...
//Check address(UDP monitor and TCP monitor when accepting connections).
	...
	//IPv6
		...
		{
			if (!OperationModeFilter(AF_INET6, &((PSOCKADDR_IN6)&LocalSocketData.SockAddr)->sin6_addr))
				return false;
		}
	//IPv4
		else if (LocalSocketData.AddrLen == sizeof(sockaddr_in))
		{
			if (!OperationModeFilter(AF_INET, &((PSOCKADDR_IN)&LocalSocketData.SockAddr)->sin_addr))
				return false;
		}
		else {
			return false;
...
//Scan all Resource Records.
	...
	//Standard Resource Records
		auto DNS_Record_Standard = (pdns_record_standard)(Packet->Buffer + PacketIndex + RecordLength);
			...
			//IPv6(AAAA records)
				...
				//Make response.
					...
					//Make resource records.
						...
						if (Index == 0)
							((pdns_record_aaaa)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.at(RamdomIndex).IPv6.sin6_addr;
						else if (Index == RamdomIndex)
							((pdns_record_aaaa)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.front().IPv6.sin6_addr;
						else 
							((pdns_record_aaaa)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.at(Index).IPv6.sin6_addr;
			...
			//IPv4(A records)
				...
				//Make response.
					...
					//Make resource records.
						...
						if (Index == 0)
							((pdns_record_a)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.at(RamdomIndex).IPv4.sin_addr;
						else if (Index == RamdomIndex)
							((pdns_record_a)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.front().IPv4.sin_addr;
						else 
							((pdns_record_a)DNS_Record)->Address = HostsTableIter.AddrOrTargetList.at(Index).IPv4.sin_addr;
...
//Scan all Resource Records.
	...
	//Pointer check
		...
		{
			const uint16_t DNS_Pointer = ntohs(*(uint16_t *)(Buffer + DataLength)) & DNS_POINTER_BITS_GET_LOCATE;
	...
	//Standard Resource Records
		const auto DNS_Record_Standard = (pdns_record_standard)(Buffer + DataLength);
