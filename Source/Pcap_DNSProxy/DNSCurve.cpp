...
size_t LocalSignatureRequest(const char *OriginalSend, const size_t SendSize, PSTR OriginalRecv, const size_t RecvSize)
{
//Initialization
...
bool __fastcall GetSignatureData(const char *Buffer, const size_t ServerType)
{
