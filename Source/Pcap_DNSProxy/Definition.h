...
#endif
#define DOMAIN_LABEL_MAXSIZE                          64U                               //Maximum size of domain label, in bytes(A label must be 63 characters/bytes or less, Section 2.3.1 in RFC 1035).
#define DOMAIN_RANDOM_MINSIZE                         6U                                //Minimum size of random domain
#define DOMAIN_WHOLE_MAXSIZE                          256U                              //Maximum size of whole domain, in bytes(Section 2.3.1 in RFC 1035)
...
#define EDNS_RECORD_MAXSIZE                           (sizeof (uint8_t) + sizeof(dns_record_edns) + sizeof(edns_cookies) + sizeof(edns_client_subnet) * 2U + sizeof(in6_addr) + sizeof(in_addr))                    //Maximum of EDNS resource record size
#if defined(ENABLE_LIBSODIUM)
