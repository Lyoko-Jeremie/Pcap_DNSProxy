...
..\Support\md5 -cFE925023AB904B93D242481D05F9D838 ..\Support\curl.exe 2>nul||echo.依赖程序似乎被破坏了, 重新安装一次试试?&&ping -n 5 127.0.0.1>nul&&goto END
...
if not "%ST%" == "LOCAL" (
	...
	curl "file://delegated-apnic-latest" -o "delegated-apnic-latest" 2>nul||echo.不存在本地文件..&&ping /n 2 127.0.0.1>nul
	del /F /Q curl.exe
	goto END
)
goto :eof
