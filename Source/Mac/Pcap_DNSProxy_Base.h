...
#include <sys/socket.h>            //Main socket
...
//Internet Protocol version 4/IPv4 Address(Linux/Mac, from Microsoft Windows)
...
//Internet Control Message Protocol/ICMP Header(Linux/Mac)
