...
{
//Platform of Mac OS X is only Little Endian
...
bool CheckSpecialAddress(const void *pAddr, const size_t Protocol)
{
	...
	//About this list, see https://en.wikipedia.org/wiki/IPv6_address#Presentation and https://en.wikipedia.org/wiki/Reserved_IP_addresses#Reserved_IPv6_addresses
		if ((Addr->__u6_addr.__u6_addr16[0] == 0 && Addr->__u6_addr.__u6_addr16[1] == 0 && Addr->__u6_addr.__u6_addr16[2] == 0 && Addr->__u6_addr.__u6_addr16[3] == 0 && Addr->__u6_addr.__u6_addr16[4] == 0 &&
			((Addr->__u6_addr.__u6_addr16[5] == 0 &&
			(((Addr->__u6_addr.__u6_addr16[6] == 0 && Addr->__u6_addr.__u6_addr16[7] == 0) || //Unspecified address(::, Section 2.5.2 in RFC 4291)
			(Addr->__u6_addr.__u6_addr16[6] == 0 && Addr->__u6_addr.__u6_addr16[7] == htons(0x0001))) || //Loopback address(::1, Section 2.5.3 in RFC 4291)
			Addr->__u6_addr.__u6_addr16[5] == 0)) || //IPv4-Compatible Contrast address(::/96, Section 2.5.5.1 in RFC 4291)
			Addr->__u6_addr.__u6_addr16[5] == htons(0xFFFF))) || //IPv4-mapped address(::FFFF:0:0/96, Section 2.5.5 in RFC 4291)
//			Addr->__u6_addr.__u6_addr16[0] == htons(0x0064) && Addr->__u6_addr.__u6_addr16[1] == htons(0xFF9B) && Addr->__u6_addr.__u6_addr16[2] == 0 && Addr->__u6_addr.__u6_addr16[3] == 0 && Addr->__u6_addr.__u6_addr16[4] == 0 && Addr->__u6_addr.__u6_addr16[5] == 0 || //Well Known Prefix(64:FF9B::/96, Section 2.1 in RFC 4773)
			(Addr->__u6_addr.__u6_addr16[0] == htons(0x0100) && Addr->__u6_addr.__u6_addr16[1] == 0 && Addr->__u6_addr.__u6_addr16[1] == 0 && Addr->__u6_addr.__u6_addr16[1] == 0 && Addr->__u6_addr.__u6_addr16[1] == 0 && Addr->__u6_addr.__u6_addr16[1] == 0) || //Discard Prefix(100::/64, Section 4 RFC 6666)
			(Addr->__u6_addr.__u6_addr16[0] == htons(0x2001) &&
			(Addr->__u6_addr.__u6_addr16[1] == 0 || //Teredo relay/tunnel address(2001::/32, RFC 4380)
			(Addr->__u6_addr.__u6_addr8[2] == 0 && (u_int16_t)Addr->__u6_addr.__u6_addr8[3] <= htons(0x07)) || //Sub-TLA IDs assigned to IANA(2001:0000::/29, Section 2 in RFC 4773)
			((u_int16_t)Addr->__u6_addr.__u6_addr8[2] >= htons(0x01) && (u_int16_t)Addr->__u6_addr.__u6_addr8[3] >= htons(0xF8)) || //Sub-TLA IDs assigned to IANA(2001:01F8::/29, Section 2 in RFC 4773)
			((u_int16_t)Addr->__u6_addr.__u6_addr8[3] >= htons(0x10) && (u_int16_t)Addr->__u6_addr.__u6_addr8[3] <= htons(0x1F)) || //Overlay Routable Cryptographic Hash IDentifiers/ORCHID address(2001:10::/28 in RFC 4843)
			Addr->__u6_addr.__u6_addr16[1] == htons(0x0DB8))) || //Contrast address prefix reserved for documentation(2001:DB8::/32, RFC 3849)
//			Addr->__u6_addr.__u6_addr16[0] == htons(0x2002) && Addr->__u6_addr.__u6_addr16[1] == 0 || //6to4 relay/tunnel address(2002::/16, Section 2 in RFC 3056)
			(Addr->__u6_addr.__u6_addr16[0] == htons(0x3FFE) && Addr->__u6_addr.__u6_addr16[1] == 0) || //6bone address(3FFE::/16, RFC 3701)
			(u_int16_t)Addr->__u6_addr.__u6_addr8[0] == htons(0x5F) || //6bone address(5F00::/8, RFC 3701)
//			Addr->__u6_addr.__u6_addr8[0] >= htons(0xFC) && Addr->__u6_addr.__u6_addr8[0] <= htons(0xFD) || //Unique Local Unicast address/ULA(FC00::/7, Section 2.5.7 in RFC 4193)
			((u_int16_t)Addr->__u6_addr.__u6_addr8[0] == htons(0xFE) &&
			(((u_int16_t)Addr->__u6_addr.__u6_addr8[1] >= htons(0x80) && (u_int16_t)Addr->__u6_addr.__u6_addr8[1] <= htons(0xBF)) || //Link-Local Unicast Contrast address(FE80::/10, Section 2.5.6 in RFC 4291)
			(u_int16_t)Addr->__u6_addr.__u6_addr8[1] >= htons(0xC0))) || //Site-Local scoped address(FEC0::/10, RFC 3879)
//			Addr->__u6_addr.__u6_addr8[0] == htons(0xFF) || //Multicast address(FF00::/8, Section 2.7 in RFC 4291)
			Addr->__u6_addr.__u6_addr16[5] == htons(0x5EFE)) //ISATAP Interface Identifiers(Prefix::5EFE:0:0:0:0/64, Section 6.1 in RFC 5214)
				return true;
	}
	else { //IPv4
...
//Initialization
	...
	//IPv6
		...
		//Convert from in6_addr to string
			...
			{
				PrintError(Socket_Error, L"Local IPv6 Address format error", errno, NULL);
	...
	//IPv4
		...
		//Convert from in_addr to string
			...
			{
				PrintError(Socket_Error, L"Local IPv4 Address format error", errno, NULL);
